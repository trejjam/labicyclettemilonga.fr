    ...
    >
      <div className="container ml-auto mr-auto">
        <nav className="flex flex-wrap items-center justify-between py-4 transition-all duration-500 lg:flex-nowrap">
          <Link href={{ pathname: langPrefix }} className="inline-block whitespace-nowrap">
          ...
          <div className="ms-auto flex items-center px-2.5 lg:hidden">
            ...
            <button
              className="hs-collapse-toggle inline-flex h-9 w-12 items-center justify-center rounded-md border ml-8 border-gray-300 bg-slate-300/30"
              type="button"
            >
              <IconifyIcon
                icon="uil:bars"
          ...
          >
            <ul className="mt-4 inline-flex flex-col justify-center gap-x-4 w-full lg:mt-0 lg:flex-row lg:items-center">
              <Links lang={lang} className={cn(
