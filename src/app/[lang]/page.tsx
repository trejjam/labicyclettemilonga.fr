...
import IconifyIcon from '@/components/wrapper/IconifyIcon.tsx';
        ...
        <div>
          ...
          <div className="flex justify-center">
            <div className="relative mt-14">
              <div>
                <TimeDuration lang={lang} deadline={new Date(2024, 11, 5, 0, 0, 0, 0)} />
              </div>
            </div>
          </div>
          <div className="flex justify-center">
            <div className="relative mt-10">
              <h6 className="mb-4 text-center text-lg text-white">{t('follow-us')}:</h6>
              ...
              <button
                ...
                onClick={() => window.open('mailto:danse@labicyclettemilonga.fr')}>
                <IconifyIcon icon="ix:e-mail" className="me-2 text-xl" /> Contact Us
              </button>
            </div>
          </div>
        </div>
